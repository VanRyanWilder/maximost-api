...
app.use("/api/*", cors({
  origin: "*",
  // TODO: Restrict in production to specific frontend domains
...
app.route("/api/habits", habitRoutes_default);
app.route("/api/users", userRoutes_default);
